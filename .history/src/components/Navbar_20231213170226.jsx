...
const Links = styled.ul`
  ...
  .loginlist:first-child::after {
    border-right: 2px solid #dddddd; /* 원하는 border 스타일 및 색상으로 설정 */
    padding-right: 14px; /* 오른쪽에도 padding을 추가하여 border와 겹치지 않도록 조절 */
    height: 14px;
  }
      ...
      <NavbarContatiner toggle={clicked} position={position}>
        <NavContent>
          ...
          <Links toggle={clicked}>
            ...
            <ul>
              {/* <li>
                <StyledLink className="link" to={"/en"}>
                  ENG
                </StyledLink>
              </li> */}
              <li className="loginlist">
                <StyledLink className="link" to={"/Login"}>
                  <FontAwesomeIcon
                    icon={faUser}
                    style={{ color: "#656d7b", marginRight: "5px" }}
                  />
                  로그인
                </StyledLink>
              </li>
